...
//        u = dc.addUser(u);
//        author = u.getId();
//        base = ac.addBaseArticle("Base title", "Base body", u.getId(), new Timestamp(100), new Timestamp(100), new Timestamp(100));
...
//            addArticle = ac.addArticle(title, body, u.getId(), parentArticle, new Timestamp(115), new Timestamp(115), new Timestamp(115), false);
//        }
//        addArticle = ac.getArticle(addArticle.getId());
//        if (addArticle == null) {
//            throw new Exception();
//        }
//    }
...
//        assertTrue("Resulting list is null", !result.isEmpty());
